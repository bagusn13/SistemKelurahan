    ...
    <div class="col">
      ...
      <h5><i class="icon fas fa-ban"></i> Alert!</h5>', '</div>');
        ...
        <h5><i class="icon fas fa-ban"></i> Alert!</h5>' . $error_upload . '</div>';
          ...
          echo form_open_multipart('surat_keputusan/add') ?>
          <div class="form-group">
            <label>Meteri Keputusan</label>
            <input name="materi" class="form-control" placeholder="Materi Keputusan" value="<?= set_value('materi') ?>">
          </div>
