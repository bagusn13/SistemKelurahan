    ...
    <div class="col">
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          ...
          echo form_open_multipart('surat_keluar/add') ?>
          ...
          <div class="form-group">
            <label>Kode</label>
            <input name="kode" class="form-control" placeholder="Kode" value="<?= set_value('kode') ?>">
          </div>
          ...
          <div class="form-group">
            <label>Kepada</label>
            <input name="kepada" class="form-control" placeholder="Kepada" value="<?= set_value('kepada') ?>">
          </div>
