      ...
      <div class="card card-primary">
        <div class="card-header">
          ...
          <div class="card-tools">
            <a href="<?= base_url('surat_tugas/add') ?>" type="button" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>
              Add</a>
          </div>
          <!-- /.card-tools -->
        </div>
              ...
              foreach ($arsip as $key => $value) { ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?= base_url('surat_tugas/edit/' . $value->id_surat) ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Yakin ingin menghapus arsip surat dengan tentang <?= $value->tentang ?></p>
        </div>
        <?php
        echo form_open('surat_tugas/delete/' . $value->id_surat);
        ?>
  ...
  <div class="modal fade" id="view<?= $value->id_surat ?>">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <iframe src='<?php echo base_url() ?>assets/arsipSurat/tugas/<?= $value->surat ?>' width="100%" height="600"></iframe>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
