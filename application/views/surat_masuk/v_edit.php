    ...
    <div class="col">
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          ...
          echo form_open_multipart('surat_masuk/edit/' . $arsip->id_surat)
          ?>
          <div class="form-group">
            <label>Dari</label>
            <input name="dari" class="form-control" placeholder="Dari" value="<?= $arsip->dari ?>">
          </div>
          ...
          <div class="form-group">
            <label>Di</label>
            <input name="di" class="form-control" placeholder="Di" value="<?= $arsip->di ?>">
          </div>
