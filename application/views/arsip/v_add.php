  ...
  <div class="card card-primary">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input name="judul_surat" class="form-control" placeholder="Judul Surat" value="<?= set_value('judul_surat') ?>">
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <img src="<?= base_url('assets/image/unnamed.png') ?>" alt="" id="gambar_load" width="150px">
          </div>
        </div>
      </div>
